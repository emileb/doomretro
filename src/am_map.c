...
static void AM_DrawPlayerArrow(const mline_t *lineguy, const int lineguylines, const angle_t angle,
    const fixed_t x, const fixed_t y, void (*putdot)(int, int, const byte *))
{
